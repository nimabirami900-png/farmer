...
<head>
    ...
    <title>سایت کارشناسان کشاورزی</title>
    <!-- استفاده از فونت اینتر برای ظاهری مدرن‌تر -->
    <link href="https://fonts.googleapis.com/css2?family=Vazirmatn:wght@400;700&display=swap" rel="stylesheet">
    <!-- لینک سی‌دی‌ان Tailwind CSS برای استایل‌دهی سریع -->
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        body {
            font-family: 'Vazirmatn', sans-serif;
            background-color: #f0fdf4; /* رنگ سفید-سبز بسیار روشن */
        }
        /* تعریف رنگ‌های سفارشی بر اساس خواسته‌ی شما */
        .bg-custom-green {
        ...
        /* استایل SVG و انیمیشن‌ها */
        .watering-tree-container {
            width: 150px;
            height: 150px;
            position: relative;
        }
        ...
        /* استایل افکت‌های کشاورزی برای بخش اصلی */
        .agricultural-effect {
            position: relative;
